...
class OCRPredictor(nn.Module, _OCRPredictor):
    ...
    def __init__(
        ...
        reco_predictor: Union[RecognitionPredictor, TrOCRPredictor],
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        name_model = self.det_predictor.model.__name__()
        ...
        # else:
            # preprocessor = TrOCRPreProcessor()
