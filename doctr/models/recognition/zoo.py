...
from .trocr.pytorch import indic_trocr, TROCR
...
def _predictor(arch: Any, pretrained: bool, **kwargs: Any) -> Union[RecognitionPredictor, TROCR]:
    ...
    elif arch =="indic_trocr":
        predictor = indic_trocr(pretrained=True, model_path="doctr/models/trocr_files")
    return predictor


def recognition_predictor(arch: Any = "crnn_vgg16_bn", pretrained: bool = False, **kwargs: Any) -> Union[RecognitionPredictor, TROCR]:
